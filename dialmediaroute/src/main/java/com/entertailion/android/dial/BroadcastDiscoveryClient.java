...
public class BroadcastDiscoveryClient implements Runnable {
	...
	private static final String LOG_TAG = "BroadcastDiscoveryClien";
	...
	public static final int BROADCAST_RESPONSE = 42;
...
//			Log.d(LOG_TAG, "response=" + strPacket);
			...
			Message message = mHandler.obtainMessage(BROADCAST_RESPONSE, advert);
