 ...
 */
public class StartDialAppThread extends Thread {
    public static final String PREFS_NAME = "preferences";
    /**
     * Request code used by this activity.
     */
    protected static final int CODE_SWITCH_SERVER = 1;
    private static final String LOG_TAG = StartDialAppThread.class.getSimpleName();
    ...
    private final DialServer dialServer;
    ...
    public StartDialAppThread(DialServer dialServer) {
